...
class ComplaintUploadPic extends StatefulWidget {

  @override
  _ComplaintUploadPicState createState() => _ComplaintUploadPicState();
}

class _ComplaintUploadPicState extends State<ComplaintUploadPic> {
  UploadTask task;
  File _imageFile;
  ...
  Future uploadImageToFirebase() async {
    ...
    final urlDownload = await taskSnapshot.ref.getDownloadURL().whenComplete(() {
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context) => ComplaintHome()));
    });

    Provider.of<DatabaseMethods>(context, listen: false).initComplaintPost =
        urlDownload;
    print("Download Url of Complaint Picture:");
