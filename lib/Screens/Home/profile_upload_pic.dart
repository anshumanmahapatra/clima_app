...
class ProfileUploadPic extends StatefulWidget {

  @override
  _ProfileUploadPicState createState() => _ProfileUploadPicState();
}

class _ProfileUploadPicState extends State<ProfileUploadPic> {
  UploadTask task;
  File _imageFile;
  ...
  Future uploadImageToFirebase() async {
    ...
    Provider.of<DatabaseMethods>(context, listen: false).initPhotoUrl =
        urlDownload;
    print("Download Url of Profile Picture:");
